...
EOS_idx = 2
SOS_idx = 3
USR_idx = 4 # user, speaker
SYS_idx = 5 # system, listener
CLS_idx = 6
...
parser.add_argument("--is_reverse", default=False, action="store_true")
parser.add_argument("--tree_pos_enc", default=True, action="store_true")
parser.add_argument("--prepend_emo", default=False, action="store_true")
parser.add_argument("--emo_enhance", default=True, action="store_true")
parser.add_argument("--emo_tree", default=True, action="store_true")
parser.add_argument("--emo_flat", default=False, action="store_true")

parser.add_argument("--dp_y_gen", default=False, action="store_true")
...
parser.add_argument("--model", type=str, default="EmoDT")
...
prepend_emo = args.prepend_emo
emo_enhance = args.emo_enhance
emo_tree = args.emo_tree
emo_flat = args.emo_flat
dp_y_gen = args.dp_y_gen
